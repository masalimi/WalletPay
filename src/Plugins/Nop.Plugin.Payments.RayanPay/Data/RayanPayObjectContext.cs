...
{
    public class RayanPayObjectContext : DbContext, IDbContext
	{
        public RayanPayObjectContext(DbContextOptions<RayanPayObjectContext> options) : base(options)
        {
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.ApplyConfiguration(new RayanPayServiceProxyTransactionRecordMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(RayanPayServiceProxyTransactionRecord));
        }
