...
{
    public class WalletUserDataObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public WalletUserDataObjectContext(DbContextOptions<WalletUserDataObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new WalletUserDataMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(WalletUserData));
        }
