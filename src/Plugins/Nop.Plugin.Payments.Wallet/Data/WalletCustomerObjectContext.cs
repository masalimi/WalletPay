...
{
    public class WalletCustomerObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public WalletCustomerObjectContext(DbContextOptions<WalletCustomerObjectContext> options) : base(options)
        {
        }
