...
{
    public class WalletCustomerHistoryObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public WalletCustomerHistoryObjectContext(DbContextOptions<WalletCustomerHistoryObjectContext> options) : base(options)
        {
        }
        ...
        public virtual IQueryable<TQuery> QueryFromSql<TQuery>(string sql, params object[] parameters)
            where TQuery : class
        {
